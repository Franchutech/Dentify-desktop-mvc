...
/*INSERS PARA PROABR LAS TARJETAS DEL HISTORIAL CLINICO*/

INSERT INTO CITA (fecha, hora, motivo, id_estado, id_paciente, id_doctor) VALUES
                                                                              ('2026-05-18', '10:00:00', 'Fase 2 de implante', 2, 1, 101),
                                                                              ('2026-05-22', '11:30:00', 'Revisión de suturas y ajuste', 2, 1, 101),
                                                                              ('2026-05-28', '09:00:00', 'Blanqueamiento definitivo', 2, 1, 101);


INSERT INTO DETALLE_CITA (id_cita, id_tratamiento, observaciones) VALUES
                                                                      ((SELECT max(id_cita) FROM CITA WHERE fecha = '2026-05-18' AND id_paciente = 1), 8, 'Colocación de perno de titanio en pieza 14. Excelente osteointegración preliminar.'),
                                                                      ((SELECT max(id_cita) FROM CITA WHERE fecha = '2026-05-22' AND id_paciente = 1), 4, 'Retirada de puntos limpia. Ligera inflamación en la encía marginal. Se prescribe enjuague con clorhexidina.'),
                                                                      ((SELECT max(id_cita) FROM CITA WHERE fecha = '2026-05-28' AND id_paciente = 1), 6, 'Aplicación de gel aclarador químico. Sensibilidad dental posterior controlada. El tono bajó dos niveles.');